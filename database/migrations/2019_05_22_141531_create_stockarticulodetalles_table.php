...
class CreateStockarticulodetallesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stockarticulodetalles', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('stockarticulodetalles');
    }
}
