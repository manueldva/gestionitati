...
@section('content_header')
  <h1>
     Informe Movimiento Cuenta Corriente del Cliente
    <!--<small>Listado</small>-->
  </h1>
  <ol class="breadcrumb">
...
<div class="box box-primary">
	<div class="box-header with-border box-default">
	   <strong> Ver Informe Movimientos </strong>
	</div>
...
@push('js')
	...
	<script type="text/javascript">
		...
		$('#imprimir').on('click', function(e){
            ...
            e.preventDefault();
            window.open("{{url('informemovimientoccprint')}}/"+ cliente_id + "/" + fechadesde + "/" + fechahasta);
