...
<div class="box box-primary">
	<div class="box-header with-border box-default">
	   <strong> Ver Informe Gastos </strong>
	</div>
            ...
            <div class="col-md-6">
                {!! Form::open() !!}
                    ...
                    <div class="form-group">
                        ...
                        {{ form::select('rubrogasto_id', $tipogastos,  null, ['class' => 'form-control','placeholder' => 'Seleccionar'] ) }}
                    </div>
...
@push('js')
	...
	<script type="text/javascript">
		...
		$('#imprimir').on('click', function(e){
            ...
            var rubrogasto_id = $("#rubrogasto_id option:selected").attr("value")
            //alert(usuario);
            if (rubrogasto_id == '')
            {
                rubrogasto_id = 0;
            ...
            e.preventDefault();
            window.open("{{url('informegastoprint')}}/"+ rubrogasto_id + "/" + fechadesde + "/" + fechahasta);
