...
@section('content_header')
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Nueva Asignacion</li>
    </ol>
...
<div class="box box-primary">
  <div class="box-header with-border box-default">
    <strong>Nueva Asignaciones de Stock</strong>
  </div>
    
  <div class="panel-body">
    <div class="row">

  {!! Form::open(['route' => 'stockasignaciones.store', 'files' => true, 'id' => 'form']) !!}
...
@include('admin.stockasignaciones.partials.form')
